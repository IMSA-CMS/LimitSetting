...
void construct_models_Higgs_6()
{
	...
	std::cout << "\n \n \n";
	std::cout << "Signal and Background fit functions extracted \n";
	...
	for (auto [unmodifiedChannelName, fitFunctions] : signalParameters)
	{
		...
		std::cout << "Signal Channel: " << channel << "\n";
	...
	for (auto [unmodifiedChannelName, fitFunctions] : backgroundParameters)
	{
		...
		std::cout << "Background channel: " << channel << "\n";
	...
	for (std::string channel : channelsToCheck)
	{
		...
		for(std::string X_or_Y : signs)
		{
			...
			std::cout << "currentSignalChannel: " << *currentSignalChannel << "\n";
			std::cout << "currentBackgroundChannel: " << *channel << "\n";
	...
	// std::vector<RooPDF_DSCB_test> signal_X_and_Y;f
	// 	std::vector<std::string> signal_X_and_YNames;
