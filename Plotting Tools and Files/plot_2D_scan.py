...
f = ROOT.TFile("higgsCombineTest.MultiDimFit.mH500.root")
t = f.Get("limit")
...
x, y, deltaNLL = [], [], []
for ev in t:
    x.append( getattr(ev,"realHiggsMass") )
    y.append( getattr(ev,"range") )
...
#print(grid_vals) grid vals is filled with nans
...
c68.Draw("cont3same")
c95.Draw("cont3same")
#print(grid_vals) Grid vals is empty
